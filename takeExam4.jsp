    ...
    <div class="container">
        ...
        <div class="question">
            <label for="question1">*Question 1:<br>
            	Describe the structure and operations of a singly linked list. How does it differ from a doubly linked list?
        ...
        <div class="question">
            <label for="question2">*Question 2:<br>
            	Explain the differences between if-else statements and switch statements in programming.
            </label>
        ...
        <div class="question">
            <label for="question3">*Question 3: <br>
            	What are the differences between primitive data types and reference data types in programming?  
