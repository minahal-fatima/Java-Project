...
<body>
    <div class="container">
        ...
        <div class="buttons">
            <a href="AddExam.jsp"><input type="button" value="Add Exam and Questions"></a><br>
            <a href="SearchStudent.jsp"><input type="button" value="Search Student"></a><br>
            <a href="UpdateStudent.jsp"><input type="button" value="Update Record"></a><br>
        </div>
        </form>
    </div>
</body>
